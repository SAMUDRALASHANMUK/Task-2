    ...
    public void addEmployee()
    {
        ...
        switch (select) {
            case 1 -> {
                ...
                System.out.println("-------------------------------------");
                System.out.println("Enter the permanent employee id");
                int id = scanner.nextInt();
                while (permanentEmpHashMap.containsKey(id))
                {
            ...
            case 2 -> {
                System.out.println("-------------------------------------");
                System.out.println("Enter the contract employee details");
                System.out.println("-------------------------------------");
                System.out.println("Enter the contract employee id");
                int id = scanner.nextInt();
                while (contractEmpHashMap.containsKey(id))
                {
                    System.out.println("Duplicate id found enter id again");
                    id = scanner.nextInt();
                }
            ...
            case 3 -> {
                ...
                System.out.println("Enter the contract employee id");
                int id = scanner.nextInt();
                while (parttimeEmpHashMap.containsKey(id))
                {
                    System.out.println("Duplicate id found enter id again");
                    id = scanner.nextInt();
                }
